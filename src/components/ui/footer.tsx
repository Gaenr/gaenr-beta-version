		...
		<div className="w-full border-t border-slate-100 py-10 lg:py-16">
			<footer className="max-w-8xl mx-auto grid w-full grid-cols-2 gap-12 px-6 lg:grid-cols-7">
				<div className="col-span-full space-y-6 lg:col-span-3">
					...
					<ul className="flex flex-col gap-y-4">
						<li className="flex items-center gap-x-2">
							<LocationIcon className="text-zinc-400" />
						...
						<li className="flex items-center gap-x-2">
							...
							<p className="text-sm text-zinc-500">gaenr@support.com</p>
						</li>
						<li className="flex items-center gap-x-2">
							<WhatsappIcon className="text-zinc-400" />
				...
				<div className="col-span-full grid grid-cols-1 place-items-center gap-y-6 md:grid-cols-[max-content_1fr] md:gap-y-3">
					...
					<div className="flex items-end justify-center gap-x-3 rounded-xl border border-zinc-800 px-4 py-2 md:place-self-end">
						<Image
							src="/flag.png"
							alt="Palestine Flag"
							width={28}
