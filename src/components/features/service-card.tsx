...
export default function ServiceCard({
	...
	return (
		<motion.div
			className="relative w-full overflow-hidden rounded-3xl border border-slate-200 bg-white p-1.5"
			ref={ref}
			...
			<AnimatePresence>
				{show && (
					<motion.div
						...
						<Button className="scale-35 text-base">
							<Link href={`/services/${link}`}>View Service</Link>
						</Button>
					</motion.div>
				)}
			</AnimatePresence>
